  ...
  return (
    <section>
      <div
        ...
        className="flex flex-row justify-between bg-gradient-to-r from-white via-[#D9AB91]/40 via-40% to-white max-w-screen lg:min-h-screen py-44 md:py-auto"
      >
        <div className="flex flex-col  lg:w-[60%] w-full md:gap-6 gap-2 justify-center">
          <h1 className="text-[#D9AB91] md:text-xl text-lg">
            WELCOME TO MY WORLD
          </h1>
          ...
          <p className="mt-2 text-3xl md:text-5xl">a Frontend Developer</p>
          ...
          <div className="flex md:flex-row flex-col md:items-center md:gap-8 gap-4 md:mt-9 mt-4">
            <Button
              ...
              disabled={loading}
              className="hover:bg-[#d29b7b] disabled:opacity-100 rounded-4xl md:w-52 w-40 md:p-8 p-5 md:text-xl text-sm font-semibold text-white text-center bg-[#dda381] "
            >
            ...
            <div className="flex flex-row gap-6 md:mt-0 mt-4">
              ...
              >
                <InstagramIcon className="bg-white text-[#D9AB91] rounded-full p-3 md:h-14 h-12 md:w-14 w-12 border-2 border-[#D9AB91]" />
              </a>
              <a
                ...
                rel="noopener noreferrer"
              >
                <Twitter className="bg-white text-[#D9AB91] rounded-full p-3 md:h-14 h-12 md:w-14 w-12 border-2 border-[#D9AB91]" />
              </a>
              <a
                ...
                rel="noopener noreferrer"
              >
                <LucideLinkedin className="bg-white text-[#D9AB91] rounded-full p-2 md:h-14 h-12 md:w-14 w-12 border-2 border-[#D9AB91]" />
              </a>
            </div>
          </div>
        </div>
